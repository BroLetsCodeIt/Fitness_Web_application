...
import { fetchRecipe, fetchRecipes } from '../../utils/fetchingRecipes.jsx'
              ...
              <div className='flex flex-wrap gap-4'>
                {
                  recipe?.healthLabels.map((item, index) => (
                    <p className='text-black flex gap-2 bg-[#3fffd218] px-4 py-1 rounded-full items-center border-spacing-1' key={index}>
